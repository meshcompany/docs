...
<CardGroup cols={2}>
  ...
  <Card title="GitHub Examples" icon="github" href="https://github.com/meshai-protocol/examples">
    Browse example agent implementations and templates
  </Card>
  <Card title="Technical Support" icon="headset" href="mailto:agents@meshai.network">
