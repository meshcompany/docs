...
<Tabs>
  ...
  <Tab title="Proposal Creation">
    ...
    **Approval Bonus**: 2,000 $MESH if proposal passes with >60% support
  ...
  <Tab title="Delegation Rewards">
    ...
    **Performance Bonus**: +100% if delegation voting rate >90%
...
<CardGroup cols={2}>
  ...
  <Card title="Voting Interface" icon="square-poll-vertical" href="https://vote.meshai.network">
    On-chain voting platform with delegation and proposal tracking
  </Card>
  <Card title="Governance Analytics" icon="chart-bar" href="https://analytics.meshai.network/governance">
    Real-time data on proposals, voting patterns, and participation rates
  </Card>
  <Card title="Discord Governance" icon="discord" href="https://discord.gg/meshai">
